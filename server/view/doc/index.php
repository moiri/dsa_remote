            ...
            <div class="btn-group" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <!-- <li><a href="#" id="toc-chap-intro">Einleitung</a></li> -->
                        <li><a href="#" id="toc-chap-qvat">QVAT</a></li>
                        <li><a href="#" id="toc-chap-allgKampf">Allgemeines zum Kampf</a></li>
                        <li><a href="#" id="toc-chap-wunden">Wunden</a></li>
                        <li><a href="#" id="toc-chap-ini">Initiative</a></li>
                        <li><a href="#" id="toc-chap-aktion">Zusätzliche Aktion/Reaktion</a></li>
                    </ul>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-default dropdown-toggle" aria-expanded="false" data-toggle="dropdown" type="button">
